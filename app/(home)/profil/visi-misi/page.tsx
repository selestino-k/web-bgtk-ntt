...
export default function VisiMisi() {
    return (
        <PrescenceMotion>
            ...
            <div id="sambutan" className="w-full max-w-7xl place-items-start px-10">
                <main className="relative z-10 flex flex-col gap-3 p-8 w-full">
                    ...
                    <div className="text-left">
                        ...
                        <ul className="list-decimal ml-5 mt-3 text-sm md:text-base font-inter text-wrap text-justify">
                            <li>
