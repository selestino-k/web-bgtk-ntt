    ...
    return (
        ...
        >
            <AccordionItem value="item-1">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Apa Itu BGTK NTT?</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Di Mana BGTK NTT Berlokasi?</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
            ...
            <AccordionItem value="item-3">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Apa Saja Layanan yang Disediakan oleh BGTK NTT?</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
                        BGTK NTT menyediakan berbagai layanan, antara lain:
                    </p>
                    <ul className="list-disc list-inside ml-4 space-y-2 text-balance md:text-base font-inter">
            ...
            <AccordionItem value="item-4">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Bagaimana Cara Menghubungi BGTK NTT?</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
            ...
            <AccordionItem value="item-5">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Apa itu program Koding dan Kecerdasan Artifisial (KKA)?</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
            ...
            <AccordionItem value="item-6">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Bagaimana cara mendaftar program Koding dan Kecerdasan Artifisial (KKA) </AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
            ...
            <AccordionItem value="item-7">
                <AccordionTrigger className="font-montserrat text-primary font-semibold text-lg">Apa saja persyaratan untuk mengikuti Program Koding dan KA?</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-4 text-balance md:text-base font-inter">
                    <p>
