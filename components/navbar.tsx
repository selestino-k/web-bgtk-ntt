      ...
      <div className="flex h-16 max-w-screen items-center text-primary justify-between px-6 md:px-4" >
        <Link href="/" className="flex items-center gap-2 hover:text-sidebar-primary" prefetch={false}>
          ...
          <div className="grid grid-flow-col grid-rows-2 mt-2">
            <span className="text-2xl font-black font-inter mt-2">Balai GTK</span>
            <span className="text-sm font-geist font-bold">Provinsi NTT</span>
          </div>
        </Link>
        
        <div className="grid justify-items-center py-1">
          <nav className="z-50 hidden md:flex items-center space-x-8 font-inter font-medium text-gray-800 hover:text-bold">
            <div className="flex items-center">
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center text-md font-medium hover:text-sidebar-primary dark:hover:text-gray-50 bg-transparent">
